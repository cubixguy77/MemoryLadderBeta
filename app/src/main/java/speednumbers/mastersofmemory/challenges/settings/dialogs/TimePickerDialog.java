...
public class TimePickerDialog extends AlertDialog.Builder implements OnClickListener {
	...
	public TimePickerDialog(Context context, int numSeconds, String labelText) {
		super(context);
		setTitle(labelText);
		setCancelable(true);
	...
	private void initTimeVariables() {
		hours = TimeUtils.getHours(numSeconds);
		minutes = TimeUtils.getMinutes(numSeconds);
		seconds = TimeUtils.getSeconds(numSeconds);
	}
