...
public class NumberChallenge {
    ...
    private static final int DIGIT_SOURCE_INDEX = 4;
    ...
    public static Setting getDigitSourceSetting(Challenge challenge) {
        return getSetting(challenge, DIGIT_SOURCE_INDEX);
    }
