...
import playChallenge.writtenNumbersChallenge.memorization.SpeedNumbers.Navigation;

class NumberGridNavigationPresenter implements Navigation.UserNavigationEvents {

    private SpeedNumbers.Grid grid;
    private NumberMemoryModel model;

    NumberGridNavigationPresenter(SpeedNumbers.Grid grid, NumberMemoryModel model) {
        this.grid = grid;
        this.model = model;
