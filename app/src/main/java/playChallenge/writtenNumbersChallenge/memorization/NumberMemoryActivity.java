...
import framework.injection.components.ChallengeComponent;
import framework.injection.components.DaggerChallengeComponent;
...
public class NumberMemoryActivity extends BaseActivityChallenge implements GameStateListener, GetChallengeInteractor.Callback {
    ...
    private void logScore(Result result) {
        ...
        params.putString(FirebaseAnalytics.Param.ITEM_ID, "Score: " + result.getNumDigitsRecalledCorrectly());
        params.putString(FirebaseAnalytics.Param.CONTENT_TYPE, result.getNumDigitsTotal() + " Digits");
